...
public partial record Packages
{
    ...
    public long? EstimatedBalance { get; init; }

    [JsonPropertyName("SiblingCount")]
    public long? SiblingCount { get; init; }

    [JsonPropertyName("IssuanceId")]
    public string? IssuanceId { get; init; }

    [JsonPropertyName("Issuances")]
    public ICollection<Issuances>? Issuances { get; init; }

    [JsonPropertyName("HasQrs")]
    public bool? HasQrs { get; init; }
